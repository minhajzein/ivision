    ...
    >
      ...
      <div className="hero-bg absolute inset-0 z-0">
        <div className="hero-image-container w-full h-full relative z-0 origin-center">
          <div className="hero-inner-image w-full h-full bg-[url('/dark_red_minimalist_hero_png_1770067795903.png')] bg-cover bg-center" />
        </div>
      ...
      <div className="container mx-auto relative z-30 text-center">
        <div ref={textRef} className="max-w-4xl mx-auto uppercase">
          ...
          <p className="hero-desc text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed normal-case font-medium">
          ...
          <div className="hero-btns flex flex-col sm:flex-row items-center justify-center gap-4 normal-case">
            <Link href="/services">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 text-white min-w-[200px] text-lg py-8 font-bold rounded-none"
              >
            ...
            <Link href="/portfolio">
              <Button
                size="lg"
                variant="outline"
                className="border-white/20 text-white hover:bg-white/10 min-w-[200px] text-lg py-8 font-bold rounded-none"
              >
                PORTFOLIO
              </Button>
            </Link>
